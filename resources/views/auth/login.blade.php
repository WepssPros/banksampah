    ...
    <body>
        <section class="h-full w-full border-box transition-all duration-500 linear" style="background-color: #f5f5f5">
            <style scoped>
                ...
                .content-4-1 .input:focus-within {
                    border: 1px solid #2ec49c;
                    color: #2a3240;
                    transition: 0.3s;
                }

                .content-4-1 .input input::placeholder {
                    color: #cacbce;
                    transition: 0.3s;
                }

                .content-4-1 .input:focus-within input::placeholder {
                    color: #2a3240;
                    outline: none;
                    transition: 0.3s;
                }

                .content-4-1 .input:focus-within .icon path {
                    transition: 0.3;
                    fill: #2ec49c;
                    transition: 0.3s;
                }

                .content-4-1 .input .icon-toggle path {
                    transition: 0.3;
                    fill: #2ec49c;
                    transition: 0.3s;
                }
                ...
                .content-4-1 .text-label {
                    color: #39465b;
                }

                .content-4-1 .text-foot {
                    color: #2a3240;
                }

                .content-4-1 .text-link {
                    color: #2ec49c;
                }
            ...
            <div class="content-4-1" style="font-family: 'Poppins', sans-serif">
                <div class="flex flex-col items-center h-full lg:flex-row">
                    ...
                    <div
                        class="flex w-full h-full px-8 width-right sm:px-16 py-32 lg:mx-0 mx-auto items-left justify-left bg-medium-white">
                        <div class="w-full sm:w-7/12 md:w-8/12 lg:w-9/12 xl:w-7/12 mx-auto lg:mx-0">
                            ...
                            <h3 class="text-3xl font-semibold mb-3">Log In to continue <br> Admin Bank Sampah</h3>
                            ...
                            <form class="mt-6" action="{{route('login')}}" method="POST" x-data="{ show: false }">
                                @csrf
                                <div class="mb-7">
                                    <label class="block text-lg font-medium text-label">Email Address</label>
                                    <div class="flex w-full px-5 py-4 mt-3 text-base font-light rounded-xl input">
                                        ...
                                        <input type="email" name="email" id="" placeholder="Your Email Address"
                                            class="w-full focus:outline-none text-base font-light bg-medium-white"
                                            autocomplete required />
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <label class="block text-lg font-medium text-label">Password</label>
                                    <div
                                        ...
                                        <input type="password" name="password" id="password-content-4-1"
                                            placeholder="Your Password" minlength="6"
                                            class="w-full focus:outline-none text-base font-light bg-medium-white"
                                            required />
                                        <div onclick="togglePassword()" @click="show = !show">
                                            <svg :class="{'icon-toggle': show}" class="cursor-pointer ml-3" width="20"
                                ...
                                <div class="mt-3 text-right">
                                    <a href="{{ route('password.request') }}"
                                        class="forgot-password text-sm italic">Forgot Password?</a>
                                </div>
                                <button type="submit"
                            ...
                            <p class="mt-8 text-center text-sm text-foot">
                                ...
                                <a href="{{route('register')}}" class="font-medium hover:underline text-link">Register
                                    Here</a>
                            </p>
                        </div>
                    </div>
