...
<h2 class="font-semibold text-xl text-gray-800 leading-tight">
    Pengajuan &raquo; {{ $item->nama_organisasi }} &raquo; Edit
</h2>
        ...
        <div class="max-w-md w-full space-y-8 p-10 bg-white rounded-xl shadow-lg z-10">
            <div class="grid  gap-8 grid-cols-1">
                ...
                <div class="flex flex-col ">
                    ...
                    <div class="mt-5">
                        <form action="{{ route('dashboard.pengajuan.update', $item->id)  }}" method="post"
                            ...
                            <div class="form">
                                <div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                    ...
                                    <div class="w-full flex flex-col mb-3">
                                        ...
                                        <input placeholder="Alamat Organisasi" value="{{$item->nama_organisasi}}"
                                ...
                                <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                    <div class="mb-3 space-y-2 w-full text-xs">
                                        <label class="font-semibold text-gray-600 py-2">Alamat Organisasi <abbr
                                                title="required">*</abbr></label>
                                        <input placeholder="Alamat Organisasi" value="{{$item->alamat}}"
                                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                    ...
                                    <div class="mb-3 space-y-2 w-full text-xs">
                                        <label class="font-semibold text-gray-600 py-2">Jumlah Warga <abbr
                                                title="required">*</abbr></label>
                                        <input placeholder="Jumlah Warga" value="{{$item->jumlahwarga}}"
                                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                ...
                                <div class="mb-3 space-y-2 w-full text-xs">
                                    ...
                                    <div class="flex flex-wrap items-stretch w-full mb-4 relative">
                                        ...
                                        <input type="date" name="tgl_pelaksana" value="{{$item->tgl_pelaksana}}"
