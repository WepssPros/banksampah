    ...
    <div class="w-full max-w-full px-3 lg:w-1/3 lg:flex-none">
        <color:div
            ...
            <div class="p-4 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                <div class="flex flex-wrap -mx-3">
                    <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                        <h6 class="mb-0">Penarikan Saldo Anda</h6>
                    </div>
                    <div class="flex-none w-1/2 max-w-full px-3 text-right">
                ...
                <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                    ...
                    <li
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="leading-tight text-size-xs">#BK-000-{{$item->id}}</span>
                            <span class="leading-tight text-size-xs">Status {{$item->status}}</span>
                        </div>
                        <div class="flex flex-col pl-2">
                            <div class="flex items-center leading-normal text-size-sm text-green-500">
                                Saldo Awal:
                                Rp.{{number_format($item->saldoawal)}}


                            </div>
                            <div class="flex items-center leading-normal text-size-sm text-blue-500">
                                Saldo Tarik:
                                Rp.{{number_format($item->saldotarik)}}
                            </div>
                        </div>
